    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('provider', 'Поставщик'), ('buyer', 'Покупатель')], default='buyer', max_length=8, verbose_name='Тип пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contact_type', models.CharField(max_length=255, verbose_name='тип контактной информации')),
